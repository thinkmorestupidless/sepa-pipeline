...
import cloudflow.akkastream.scaladsl.SourceWithOffsetContext
 ...
 */
abstract class AkkaClusterStreamletLogic(implicit val context: AkkaClusterStreamletContext) extends StreamletLogic[AkkaClusterStreamletContext] {

  override def getContext(): AkkaClusterStreamletContext = super.getContext()
